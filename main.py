...
if not all((consumer_key, consumer_secret_key, access_token,access_token_secret)):
    print('ATTENTION!!!\nVous n\'avez pas entrer les API KEYS dans le fichier "config.py" !\nLe bot ne pourra pas publier les Sections !.\n\n')
...
def main():
    try:
        ...
        print("Une erreur est survenue lors de la vérification des sections du shop!")

if __name__ == "__main__":
    while True:
        print("Recherche de changement de sections")
        main()
        sleep(20)
